...
class File(db.Model):
    ...
    rel_path = db.Column(db.String, nullable=False, index=True)
    ...
    material_type = db.Column(db.String, nullable=True, index=True)
    title = db.Column(db.String, nullable=True, index=True)
    author = db.Column(db.String, nullable=True, index=True)
    year = db.Column(db.String, nullable=True)
    advisor = db.Column(db.String, nullable=True)
    keywords = db.Column(db.String, nullable=True, index=True)
